...
const BetHistoryTable: React.FC<BetHistoryTableProps> = ({ history, sources, currentSourceId, onRemoveBet }) => {
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-amber-50/50 border-b border-amber-100">
              ...
              <th className="px-6 py-5 text-[10px] font-bold text-gray-400 uppercase tracking-widest text-center">Действие</th>
            </tr>
          </thead>
